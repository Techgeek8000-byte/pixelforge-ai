...
import {
  ...
  Share2, Lock, ImageIcon, Lightbulb,
} from 'lucide-react';
...
export default function ToolWorkspace() {
  ...
  }, [tool, promptText, selectedStyle, selectedSize, isPremium, setIsGenerating, setError, setGeneratedImageUrl]);
  ...
  const handleDownload = async () => {
    ...
    try {
      await downloadImage(generatedImageUrl, isPremium, `pixelforge-${tool.id}-${Date.now()}.png`);
    } catch {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          <div className="pf-glass-3d p-4 min-h-[400px] flex flex-col">
            {/* Loading state */}
            {isGenerating && (
              <div className="flex-1 pf-image-loading rounded-lg flex flex-col items-center justify-center gap-4">
                <Loader2 className="w-10 h-10 text-purple-400 animate-spin" />
                <div className="text-center">
                  <p className="text-sm text-slate-300 font-medium">Generating your image...</p>
            ...
            {!isGenerating && generatedImageUrl && (
              <div className="flex-1 flex flex-col">
                <div className="relative flex-1 rounded-lg overflow-hidden bg-[#0d0d1a] flex items-center justify-center">
                  <img
